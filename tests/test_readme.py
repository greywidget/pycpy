...
def test_readme_new_file(from_dir: Path, to_dir: Path):
...
@patch("typer.confirm")
def test_readme_existing_file_keep(mock_typer, from_dir: Path, to_dir: Path):
...
@patch("typer.confirm")
def test_readme_existing_file_replace(mock_typer, from_dir: Path, to_dir: Path):
